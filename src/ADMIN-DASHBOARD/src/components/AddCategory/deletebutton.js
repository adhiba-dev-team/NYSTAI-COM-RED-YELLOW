  ...
  return (
    <>
      ...
      <svg xmlns="http://www.w3.org/2000/svg" style={{ display: 'none' }}>
        <symbol xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" id="delete-top">
        ...
        <symbol xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" id="delete-bottom">
      ...
      <button 
        className={`animated-delete-btn ${isAnimating ? 'deleting' : ''} ${className}`}
        onClick={handleClick}
        disabled={disabled}
      >
        <div className="delete-icon">
          <svg className="delete-icon-top">
            <use xlinkHref="#delete-top" />
          </svg>
          <svg className="delete-icon-bottom">
            <use xlinkHref="#delete-bottom" />
          </svg>
        </div>
