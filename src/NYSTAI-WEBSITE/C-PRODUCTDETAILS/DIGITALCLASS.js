      ...
      <body className="design1details">
        <section>
          <div class="video-background-holder">
            ...
            <AsyncImage
              src={
                "/IMAGES-VIDEOS/B-IMG-PRODUCT-LAYOUT/DIGITAL CLASS/Banner.webp"
              }
            ...
            <div className="text-img-nys">
              <div className="row">
                ...
                >
                  <div className="text-left-nys">
                    <div className="parallal-text-card-heading-nys">
                      <h2>
                        <span>Elevate collaboration</span>&nbsp; with
                        interactive displays
                      </h2>
                    </div>
                    <h6>
                      The INTERACTIVE FLAT PANEL DISPLAY (IFPD) enhances
                      presentations and collaboration with a high-definition
                      touchscreen, digital whiteboarding, and annotation tools.
                      Featuring multiple connectivity options like HDMI, USB,
                      and wireless, it’s perfect for educational institutions,
                      corporate environments, or any space that values
                      interactive, seamless teamwork and effective
                      communication.{" "}
                    </h6>
                  </div>
                </div>
                ...
                >
                  <AsyncImage
                    src={
                      "/IMAGES-VIDEOS/B-IMG-PRODUCT-LAYOUT/DIGITAL CLASS/IFPD.webp"
                    }
