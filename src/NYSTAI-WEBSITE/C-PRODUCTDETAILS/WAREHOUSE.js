      ...
      <body className="design1details">
        <section>
          <div class="video-background-holder">
            ...
            <AsyncImage
              src={
                "/IMAGES-VIDEOS/B-IMG-PRODUCT-LAYOUT/Nystai-icons & resize images/ware-details.webp"
              }
              ...
              <div className="row">
                ...
                >
                  <div className="text-left-nys">
                    ...
                    <h6>
                      The "WAREHOUSE" category offers advanced safety solutions,
                      including the Anti Collision Alarm, Fork Lift Camera,
                      Smart Helmet, and Fire Detection Camera. These products
                      enhance operational safety through real-time alerts, video
                      monitoring, environmental tracking, and early fire
                      detection. Ideal for warehouses, industrial sites, and
                      hazardous environments, they ensure safety and
                      efficiency. 
                    </h6>
                  </div>
                </div>
                <div className="col-lg-6 img-right-nys mt-3">
                  <AsyncImage
                    src={
                      "/IMAGES-VIDEOS/B-IMG-PRODUCT-LAYOUT/PRODUCTDETAILS/WAREHOUSE-CATEGORY-IMAGES/Warehouse.webp"
                    }
            ...
            <div class="row row-cols-1 row-cols-md-2 g-4">
              ...
              <div class="col">
                <div class="card">
                  <AsyncImage
                    src={
                      "/IMAGES-VIDEOS/B-IMG-PRODUCT-LAYOUT/PRODUCTDETAILS/forklift.webp"
                    }
                    className=""
                    alt="..."
                  />
